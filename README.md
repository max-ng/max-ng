...
- A Mathematical Framework for Intelligence  
  [[arXiv](https://arxiv.org/abs/2509.18218)] (NEW)

- On the Definition of Intelligence  
  [[arXiv](https://arxiv.org/abs/2507.22423)] (NEW)
  In *Artificial General Intelligence*, Springer Lecture Notes in Computer Science.

- 100,000 simulations for an interesting Monte Carlo problem  
  [[url](https://medium.com/@data.scientist/solving-the-interesting-bytedance-interview-question-bb30b31cdf5)]
...
- Looped Neural Network  
  [[arXiv](https://arxiv.org/abs/2409.14199v3)]  
...
- Turn Claude, Codex, Cursor, Openclaw, and agent sessions into encrypted data assets for future AI employees.
...
<img src="assets/contact-email.png" alt="Contact email" width="360">
